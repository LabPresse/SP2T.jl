...
jldsave("./examples/2D/metadata.jld2"; metadata = metadata)
jldsave("./examples/2D/frames.jld2"; frames = detector.readouts)
jldsave("./examples/2D/groundtruth.jld2"; tracks = tracks, msd = msd)